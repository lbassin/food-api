...
final class Version20191113045213 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE meal (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', day_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', recipe_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', position INT NOT NULL, portion INT NOT NULL COMMENT \'(DC2Type:portion)\', INDEX IDX_9EF68E9C9C24126 (day_id), INDEX IDX_9EF68E9C59D8A214 (recipe_id), UNIQUE INDEX MEAL_DAY_POSITION_UNIQUE (day_id, position), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
